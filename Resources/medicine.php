    ...
    <main>
        <div class="leftmenu">
            ...
            <ul>
                ...
                <li><a id="focus" href="medicine.php">Medicine</a></li>
            ...
            if (canUpdate()) {
                foreach ($_POST as $postItem => $e) {
                    if (strpos($postItem, "updateRow") !== false) {
                        ...
                        updateRow($_SESSION["connection"], $itemId, 'medicine', $_POST["updateName"], $_POST["updateQuantity"], $_POST["updateUnit"], $_POST["updateSupplyDate"], $_POST["updateNoticeDate"]);
                        break;
                    }
                }
            }
