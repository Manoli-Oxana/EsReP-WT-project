...
<body>
    ...
    <main>
        ...
        <div class="right">
           ...
           if(canInsert())
           insertNewRow($_SESSION["connection"], 'office_supplies', $_POST["newName"], $_POST["newQuantity"], $_POST["newUnit"], $_POST["newSupply"], $_POST["newNotice"]);
            ...
            if (canUpdate()) {
                foreach ($_POST as $postItem => $e) {
                    if (strpos($postItem, "updateRow") !== false) {
                        ...
                        updateRow($_SESSION["connection"], $itemId, 'office_supplies', $_POST["updateName"], $_POST["updateQuantity"], $_POST["updateUnit"], $_POST["updateSupplyDate"], $_POST["updateNoticeDate"]);
                        break;
                    }
                }
            }
